...
export default function HeroSection() {
  return (
    <section id="hero" className="relative h-[85vh] min-h-[500px]">
      <img src={images.hero} alt="Healthcare support" className="absolute inset-0 w-full h-full object-cover" />
      ...
      <div className="relative z-10 h-full flex items-center">
        <div className="max-w-7xl mx-auto px-4 w-full">
          ...
          <p className="text-white/90 text-lg md:text-xl max-w-2xl mb-8">
            {siteConfig.tagline}. Get safe symptom guidance, quick appointment support,
            and medication reminder workflows in one place.
          </p>
          <a href="#courses"
