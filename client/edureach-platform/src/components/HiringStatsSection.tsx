        ...
        <div className="grid lg:grid-cols-2 gap-10">
          ...
          <div>
            <div className="grid grid-cols-3 gap-3 mb-6">
              <img src={images.recruter1} alt="Care camp" className="rounded-lg h-28 w-full object-cover" />
              <img src={images.recruter2} alt="Patient outreach" className="rounded-lg h-28 w-full object-cover" />
              <img src={images.moreStudents} alt="Care support" className="rounded-lg h-28 w-full object-cover" />
            </div>

            <div className="bg-white rounded-xl p-6 shadow-sm">
              <h3 className="font-heading text-lg font-semibold text-gray-800 mb-4">
                Top Care Specialties
              </h3>
