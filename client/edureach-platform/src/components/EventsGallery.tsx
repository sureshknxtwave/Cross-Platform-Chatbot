...
const CareHighlightsGallery = () => (
  <section className="py-20 bg-white">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-12">
        <p className="text-sm uppercase tracking-wider text-[#7B1E2B] font-semibold mb-2">Healthcare Community</p>
        <h2 className="text-3xl lg:text-4xl font-bold text-gray-900">Care Events & Highlights</h2>
      </div>
...
export default CareHighlightsGallery;